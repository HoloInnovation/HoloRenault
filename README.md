...
:warning: Check HoloToolkit for Unity version compatibility.
...
It is possible to import assets from the Asset Store as we did for testings.
...
In fact, [Microsoft Windows Mixed Reality Academy](https://docs.microsoft.com/en-us/windows/mixed-reality/academy) recommends to change the value of the ``Near Clip Plane`` field from the default 0.3 to 0.85, which equates to 0.85 meters.
